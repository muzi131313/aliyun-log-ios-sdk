...
Pod::Spec.new do |s|
  s.name         = "AliLogHub" # 项目名称
  s.version      = "5.0.3"        # 版本号 与 你仓库的 标签号 对应
  s.license      = { :type => "MIT", :file => "LICENSE" }          # 开源证书
  s.summary      = "阿里日志服务" # 项目简介
  s.homepage     = "https://github.com/ncnk/aliyun-log-ios-sdk" # 仓库的主页
  s.source       = { :git => "https://github.com/ncnk/aliyun-log-ios-sdk.git", :tag => "#{s.version}" }#你的仓库地址，不能用SSH地址
